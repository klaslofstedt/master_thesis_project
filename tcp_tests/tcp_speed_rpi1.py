...
logFile = MyFiles("../logs/tcp_throughput.txt")
logFile.File_Remove()
...
startupAverage = 0
sendtimeAverage = 0
fileOut = MyFiles("../input_medium.mp4")
outSize = os.path.getsize("../input_medium.mp4")
...
for x in range(0, samples):
    ...
    logFile.File_List(str(outSize / (sendtime * 1000)))
...
print "throughput: ", outSize / sendtimeAverage
